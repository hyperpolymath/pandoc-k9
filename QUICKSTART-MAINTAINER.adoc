...
// Replace pandoc-k9, pandoc-k9, {{DEPS}} with actuals
= pandoc-k9 — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining pandoc-k9 for
...
| `$PREFIX/share/pandoc-k9/`
| Data files, assets

| `$PREFIX/share/doc/pandoc-k9/`
| Documentation
...
Default config location: `$XDG_CONFIG_HOME/pandoc-k9/config.toml`

Fallback: `$HOME/.config/pandoc-k9/config.toml`
...
Or via OPSM: `opsm update pandoc-k9`
...
[source,bash]
----
just install --prefix=/opt/pandoc-k9-instance1 --config=/etc/pandoc-k9/instance1.toml
just install --prefix=/opt/pandoc-k9-instance2 --config=/etc/pandoc-k9/instance2.toml
----
...
* Upstream: https://github.com/hyperpolymath/pandoc-k9/issues
