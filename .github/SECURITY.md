...
Replace all {{PLACEHOLDER}} values with your information:
  pandoc-k9     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  pandoc-k9             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/pandoc-k9/security/advisories/new)
...
- This repository (`hyperpolymath/pandoc-k9`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/pandoc-k9/security/advisories)
...
When using pandoc-k9, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/pandoc-k9/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/pandoc-k9/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/pandoc-k9/discussions) |
...
*Thank you for helping keep pandoc-k9 and its users safe.* 🛡️
