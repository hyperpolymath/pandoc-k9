...
// Replace pandoc-k9, Pandoc K9 — See README.adoc for details., just run, Pandoc K9 started successfully. with actuals
...
* **Wiki**: https://github.com/hyperpolymath/pandoc-k9/wiki
